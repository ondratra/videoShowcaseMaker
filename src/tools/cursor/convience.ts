...
import {IPluginAppliance, IPluginConvience, IPluginConvienceParameters} from '../plugin'
...
export const convience = (elements: ICursorElements, actions: any) => (pluginsLoaded: Record<string, IPluginAppliance>, defaults: IDefaults) => {
